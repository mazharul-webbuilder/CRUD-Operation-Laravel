...
<nav class="navbar navbar-expand-md nav-link bg-white">
    <div class="container">
        <ul class="navbar-nav mx-auto">
            <li><a href="{{route('home')}}" class="nav-link text-secondary shadow mx-2">Create</a></li>
            ...
            <div class="col-md-8 mx-auto">
                <div class="card shadow">
                    <div class="card-header">
                        <h3 class="text-center text-secondary">New Category Form</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{route('category.create')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input type="submit" class="btn btn-secondary" value="Create New Category">
                                </div>
                            </div>
                        </form>
                    </div>
